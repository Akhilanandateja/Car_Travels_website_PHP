...
<div class="container1">
    ...
    ?>
        ...
        if ($status != 'booked') {
            ...
            echo '<label for="location">Choose or Enter Location:</label>';
            echo '<input list="locations" id="location" name="location" required>';
            echo '<datalist id="locations">';
            echo '<option value="Vijayawada">';
            echo '<option value="Hyderabad">';
            echo '<option value="Vizag">';
            echo '<option value="Guntur">';
            echo '</datalist>';
            echo '</div>';
            echo '<div class="form-group">';
